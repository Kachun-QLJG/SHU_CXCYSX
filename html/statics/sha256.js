function checkusrn() {
    ...
    if (username.length > 21) {
        document.getElementById("checktext1").innerHTML = " × 不要多于21位";
        check = false;
    } else {
...
function checkpwd() {
    ...
    if (password.length < 6) {
        ...
        document.getElementById("checktext2").innerHTML = " × 不要大于15位";
        check = false;
    }
    else {
...
function hashpswd() {
    ...
    document.getElementById("hashpassword").value = hex_sha256(document.getElementById("pswd").value);
    document.getElementById("verCode").value = document.getElementById("ver").value;
}
...
function check1() {
    var check = checkusrn() && checkpwd() && checkcb();
    return check;
}
/*
